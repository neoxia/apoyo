...
export const enum BooleanCode {
  STRICT = 'bool.strict',
  FROM_STRING = 'bool.fromString',
  FROM_NUMBER = 'bool.fromNumber',
  BOOL = 'bool',
  EQUALS = 'bool.equals'
}
